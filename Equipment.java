...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        // Check that all fields match (name, count, totalWeight, totalPrice, 
        //and description):
       
        boolean sameName = this.getName().equalsIgnoreCase(otherEq.getName());
        ...
        boolean sameDescription = this.getDescription().equalsIgnoreCase(otherEq.getDescription());
